...
The [case-studies](https://github.com/EdoR-dotcom/systematic-trading-hub/blob/case-study/README.md) branch represents the empirical laboratory. Here, trading strategies are backtested, optimized, and progressively improved using historical data.
